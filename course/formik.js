...
const BodyMassIndexForm = ({ onSubmit }) => {
  // useField is used to get the value of fields and change it
  // field contain the value of the field
  // mass contain meta infos such us errors
  // helper contains different actions for changing the state of field such as the setValue
  //******* the component using useField has to be wthin a Formik context ******/
